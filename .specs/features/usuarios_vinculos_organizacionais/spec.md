...
- [ ] Associar usuários de tenant a localidade, órgão e setor do mesmo schema.
- [ ] Proteger a movimentação de setores com usuários vinculados.
...
1. WHEN an `ADMIN` creates or updates a tenant user with organizational identifiers THEN the system SHALL persist only locality, organization, and sector from the verified tenant. <!-- event-driven -->
...
| --- | --- | --- | --- |
| UOR-01 | P1: User links | Design | Pending |
| UOR-02 | P1: User links | Design | Pending |
| UOR-03 | P1: Sector movement | Design | Pending |

**Coverage:** 3 total, 0 mapped to tasks, 3 unmapped.

## Success Criteria

- [ ] User organizational references and sector movement integrity are enforced per tenant.
